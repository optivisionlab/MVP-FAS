...
# Demo script to visualize heatmap for images listed in a CSV file
...
WEIGHTS="/data/fas/solution/MVP-FAS/runs/clip25/train_6/MVP_FAS_ViT-B-16/weights/MVP_FAS_ViT-B-16_best_ckpt.pt"
SAVE_PATH="runs/visualize_demo7"
